...
<head>
	...
	<link rel="shortcut icon" href="https://dsgroup.eu.org/apple-icon-57x57.png">
	...
	html{
		height:100%;
		background: #ffffff url(https://images.unsplash.com/photo-1499792914147-5e4c9a4a9684?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=161799cf6c9503ea10fbdb38afd88dca&dpr=1&auto=format&fit=crop&w=1000&q=80&cs=tinysrgb); no-repeat center bottom fixed;
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="https://dsgroup.eu.org/images/logo ds.png">
			    				
			<h1 id="cspio-headline">Maintenance Mode</h1>			    				
			
			<div id="cspio-description">We are currently performing new fresh website. Leave us your email and we'll let you know as soon as we are back up again.</div>			    				
			
			<form id="cspio-form" action="https://dsgroup.us12.list-manage.com/subscribe/post?u=e9d57f71fa1545c188f378429&amp;id=c4afea14b7" method="post">
